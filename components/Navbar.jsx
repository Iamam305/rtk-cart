...
const Navbar = () => {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
      <span className="mr-5 hover:text-white">  <Link href={'/'}>Products</Link></span>
      <span  className="mr-5 hover:text-white"><Link href={"/Cart"}>Cart</Link></span>
      <span className="mr-5 hover:text-white font-extrabold">Cart Item: {itemInCart.length}</span>
    </nav>
